            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="firstname" class="col-sm-3 control-label">Reg No</label>
                ...
                <div class="form-group">
                    <label for="lastname" class="col-sm-3 control-label">School</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_firstname" class="col-sm-3 control-label">Reg No</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_regno" name="regno">
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">School</label>
