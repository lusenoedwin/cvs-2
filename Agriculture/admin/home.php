  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header">
          <h1 style="font-weight: bold; font-size: 30px; margin-left: 20px;">
              School of Agricultural Sciences & Natural Resources Dashboard
          </h1>
          <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">School of Agricultural Sciences & Natural Resources </li>
          </ol>
      </section>
