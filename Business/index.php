    ...
    <div class="card">
      ...
      <div class="wrap-login100 p-t-85 p-b-20">
        <form class="login100-form validate-form" action="login.php" method="POST" >
            ...
            <span class="login100-form-title p-b-1">
            <label class="" style="color: black; font-size: 23px; font-weight: bold;">School of Business</label>
          </span>

          <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter Regno Number">
