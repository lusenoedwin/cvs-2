...
<div style="width:420px; margin:0 auto;">
    <div class="card">
        ...
        ";
            ...
            <label class="fa fa-check-circle" style="color: blue; font-size: 23px; font-weight: bold;"> Vote for S.G.C </label>
          </span>
                    <span class="login100-form-title p-b-1">
            <label class="" style="color: black; font-size: 23px; font-weight: bold;">Student Governing Council</label>
          </span>
